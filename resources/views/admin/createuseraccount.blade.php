        ...
        <div class="bg-dark inline-block align-bottom bg-blue-100 rounded-lg text-left overflow-hidden -xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full"
            ...
            <form method="POST" action="{{ route('createResidentAccount') }}" enctype="multipart/form-data">
                ...
                <div class="bg-white px-4 pt-4 pb-4 sm:p-6 sm:pb-4">
                    <div class="">
                    <h3 class="card-title mb-3 text-lg text-dark fw-bold text-uppercase">Create User Account</h3>
                        <div class="inputselect mb-4">
                            <label for="usertype" class="block text-black text-sm text-uppercase fw-bold mb-2">Vaccine Information</label>
                            <select name="usertype" class="block mt-1 w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md text-black  shadow-sm">
                        ...
                        <div class="mb-4">
                            <label for="exampleFormControlInput1" class="block text-black text-sm text-uppercase fw-bold mb-2">Resident Name</label>
                        ...
                        <div class="mb-4">
                            ...
                            <input name="birthDate" type="date"
                                class="appearance-none border-green-200 rounded w-full py-2 px-3  leading-tight focus:outline-none text-black  focus:shadow-outline"
                                id="exampleFormControlInput1" placeholder="Enter Date of Birth">
                            @error('birthDate')
                                <span class="text-red-500">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="inputselect mb-4">
                            ...
                            <select name="vaccinedose" class="block mt-1 w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md text-black  shadow-sm">
                        ...
                        <div class="mb-4">
                            <label for="exampleFormControlInput1"
                                class="block text-black text-sm text-uppercase fw-bold mb-2">Vaccine Card</label>
                            <x-jet-input id="vaccine" class="inputfile text-black " type="file" name="vaccine" required />
                            @error('vaccine')
                                <span class="text-red-500">{{ $message }}</span>
                            @enderror
                        </div>
                        <span class="mt-1 flex w-full sm:w-auto">
                            <button class="btn btn-dark btn-block submit" style=" height:40px;width:10rem;border-radius:10px">Create Account</button>
