<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="block mt-4">
            <x-jet-label for="vaccinedose" class="details" value="{{ __('Gender') }}" />
            <input type="radio" name="vaccinedose" value="Male" checked>
            <label for="vaccinedose">Male</label>
            <input class="ml-1" type="radio" name="vaccinedose" value="Female">
            <label for="vaccinedose">Female</label>
        </div>    
